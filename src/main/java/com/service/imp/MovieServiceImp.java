...
public class MovieServiceImp implements IMovieService{
	...
	public Integer addMovie(Movie movie) {
		System.out.println(movie.getMovie_fg_name());
	...
	@Transactional(propagation=Propagation.REQUIRED,readOnly=true)
	@Override
	public List<Movie> findMoviesByTypeAreaYear(String type, String area, String year) {
		if (type.equals("全部") || type.equals("0")) {
			type = "";
		}
		if (area.equals("全部") || area.equals("0")) {
			area = "";
		}
		if (year.equals("全部") || year.equals("0")) {
			year = "";
		}

		return this.movieMapper.findMoviesByTypeAreaYear(type, area, year);
	}
