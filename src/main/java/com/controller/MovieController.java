...
public class MovieController {
	...
	@RequestMapping("findMoviesByTypeAreaYear")
	@ResponseBody
	public JSONObject findMoviesByTypeAreaYear(@RequestParam("type") String type,@RequestParam("area") String area,@RequestParam("year") String year) {
		JSONObject obj = new JSONObject();
		List<Movie> list = movieService.findMoviesByTypeAreaYear(type, area, year);
		obj.put("code", 0);
		obj.put("count", list.size());
		obj.put("data", list);
		return obj;
